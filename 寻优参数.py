...
all_detector_ids_in_add_file = [ "e2_E1_main_0", "e2_E1_main_1"] # <--- 修改此列表，列出所有检测器ID
...
parameters_to_calibrate = {
    ...
    'lcKeepRight': (0.0, 5.0),
    'lcAssertive': (0.0, 5.0),
    'speedFactor_mean': (0.2, 2),      # Mean of speedFactor normc
    'speedFactor_std_dev': (0, 0.5)   # Std dev of speedFactor normc
